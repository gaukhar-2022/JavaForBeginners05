...
//        Распечтать объект типа string со значечением "Рыжик"
...
//        это разные типа данных и поэтому разное выводит в консоль

//        Распечатать массив catsAges
        System.out.println(catsAges);
        System.out.println(catsAges1);

//        Распечать масси catsAges с помощью класса Arrays
...
//        Распечтать значения, лежащие в ячейках 0, 7 массива catsNAmes
