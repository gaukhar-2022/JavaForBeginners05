...
//    Результат деления k на l = .., a остаток от деления = ...
//    Результат деления k на m = .., a остаток от деления = ...
//    Результат деления l на m = .., a остаток от деления = ...
//    Результат деления m на k = .., a остаток от деления = ...
    ...
    public static String returnKLMActions(int parameter1, int parameter2,  String
            varName1, String varName2) {
        int quotient = parameter1 / parameter2;
        int remainder = parameter1 % parameter2;
    ...
    public static void main(String [] args) {
        ...
        //System.out.println(printKLMActions(k, l, "k", "l")); -- Нельзя распечатать
        // результат void
